...
export function ConfirmAddModalBottom({
  ...
  return (
    <div className="p-6 mt-0 -m-6 rounded" style={{ background: '#131118' }}>
      <div className="grid gap-1">
        <div className="flex items-center justify-between">
          <div className="text-sm text-high-emphesis" style={{ color: '#A6A0BB' }}>
            {i18n._(t`Rates`)}
          </div>
      ...
      <div className="grid gap-1 pb-6">
        <div className="flex items-center justify-between">
          <div className="text-sm text-secondary" style={{ color: '#A6A0BB' }}>
      ...
      <Button color="gradient" fullWidth onClick={onAdd} style={{ borderRadius: '100px' }}>
